...
describe('dateConverter', (): void => {
	it('should get the date from an ISO string', (): void => {
		let expectedDate: moment.Moment = moment('2015-11-24T20:12:00-05:00', defaultFormats.isoFormat);
	...
	it('should convert the date to an ISO string', (): void => {
		let date: moment.Moment = moment('2015-11-24T20:12:00-05:00', defaultFormats.isoFormat);
