...
var BaseParentDataService = (function (_super) {
    ...
    function BaseParentDataService($http, $q, array, endpoint, mockData, resourceDictionaryBuilder, useMock) {
        _super.call(this, $http, $q, array, endpoint, mockData, useMock);
